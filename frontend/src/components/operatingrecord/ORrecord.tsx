...
function ORrecord() {
  ...
  const columns: GridColDef[] = [
    ...
    { field: "SurgeryType",headerName: "ประเภทการผ่าตัด",width: 120, valueFormatter: (params) => params.value.TypeName, },
    { field: "SurgeryStart",headerName: "เวลาเริ่มการผ่าตัด",width: 180, valueFormatter: (params) => params.value.SurgeryStart, },
    { field: "SurgeryEnd",headerName: "เวลาสิ้นสุดการผ่าตัด",width: 180, valueFormatter: (params) => params.value.SurgeryEnd, },
